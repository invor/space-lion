...
enum shaderType	{ PHONG,FLAT,POISSON,FXAA,IDLE,STAMP,INPAINTING,DISTANCEMAPPING,FTV_MASK,VOLUME_RAYCASTING,FTV_VOLUME_RAYCASTING,GAUSSIAN,FTV_GRADIENT,COHERENCE };
