...
namespace Landscape
{
	...
	private:
		...
		std::tuple<VertexData, IndexData, VertexLayout> computeCurveProxyMesh(uint curve_idx);

		std::tuple<VertexData, IndexData, VertexLayout> computeBitangentProxyMesh(Entity bitangent);
