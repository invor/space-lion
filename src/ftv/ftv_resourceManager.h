...
enum ftv_shaderType	{ DISTANCEMAPPING, COHERENCE, STAMP, FTV_POISSON, FTV_INPAINTING, FTV_IMPROVED_INPAINTING, FTV_MASK, FTV_VOLUME_RAYCASTING, FTV_GAUSSIAN, FTV_MASK_SHRINK, FTV_TEXTURE_ADVECTION, FTV_LIC_INPAINTING };
